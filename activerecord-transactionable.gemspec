...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/activerecord/transactionable/version.rb", mod) }::Activerecord::Transactionable::Version::VERSION
  else
    require_relative "lib/activerecord/transactionable/version"
    Activerecord::Transactionable::Version::VERSION
  end
...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/galtzo-floss/activerecord-transactionable"
  spec.licenses = ["MIT"]
  ...
  spec.metadata["homepage_uri"] = "https://github.com/pboling/activerecord-transactionable"
  ...
  package_metadata_files = %w[
    ...
    LICENSE.md
    README.md
    sig/activerecord/transactionable.rbs
  ...
  #       This gem, and its gemspec runtime dependencies, will install on Ruby down to 2.5.0.
  #       This gem, and its gemspec development dependencies, will install on Ruby down to 2.5.0.
  #       Thus, dev dependencies in gemspec must have
  #
  #       required_ruby_version ">= 2.5.0" (or lower)
  #
  #       Development dependencies that require strictly newer Ruby versions should be in a "gemfile",
  #       and preferably a modular one (see gemfiles/modular/*.gemfile).

  # Dev, Test, & Release Tasks
  spec.add_development_dependency("kettle-dev", "~> 2.5", ">= 2.5.17")             # ruby >= 2.5.0
  ...
  spec.add_development_dependency("kettle-test", "~> 2.0", ">= 2.0.19")            # ruby >= 2.5.0
