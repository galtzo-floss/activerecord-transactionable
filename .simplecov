# kettle-jem:freeze
# To retain chunks of comments & code during activerecord-transactionable templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# activerecord-transactionable will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
